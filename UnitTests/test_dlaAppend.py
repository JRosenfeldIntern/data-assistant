...
import arcpy
import pathlib
from inc_datasources import _daGPTools, _dbConnStr,  _configMatrix,_localOutputPath, _localWorkspace, _outputDirectory
...
class TestAppend(unittest.TestCase):
	...
	def testData(self):
		...
		sourceFeatureClass = ""
		for fc in arcpy.ListFeatureClasses(): #TODO: Update this to fit the new dictionary information
			if fc == "source":
